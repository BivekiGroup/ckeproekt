      ...
      >
        <div className="max-w-3xl mx-auto text-center text-white space-y-8">
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Проводим строительно-техническую экспертизу: залив квартиры,
            тепловизионное обследование, видеодиагностика канализации,
            экспертиза качества ремонта. Официальное заключение для суда.
